...
const Footer = () => {
    return (
        <div className="h-auto w-[100vw] py-14 px-3 justify-center sm:px-22 flex flex-col sm:justify-between bg-black font-gilroy  gap-12 2xl:gap-6 xl:h-screen 2xl:[110vh] overflow-hidden">
                    ...
                    <div className=" flex flex-col gap-15 p-2 ">
                        ...
                        <div className="flex flex-col gap-7  sm:flex-row   sm:justify-between ">
                            <div className="flex flex-col gap-4 ">
                                ...
                                <div className="flex flex-col gap-2 text-sm text-[#c8c8c8c5] ">
                                    <a href="tel:+917263095032">
                                        +91 7263095032
                                    </a>
                                    <a href="mailto:siddhanath@sdtorg.com">
                                        siddhanath@sdtorg.com
                                    </a>
                                </div>
                            </div>
            ...
            <div className="flex justify-center items-center text-6xl sm:text-[12rem] text-center font-bebas text-white">
                SIDDHANATH TRENDZ
            </div>
        </div>
    );
