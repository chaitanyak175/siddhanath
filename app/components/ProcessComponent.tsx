        ...
        <div className="flex flex-row justify-around p-10 gap-8 text-black font-gilroy">
            <div className="w-1/3 flex flex-col gap-6">
                <h2 className="text-4xl">
                    A complete visual merchandising tool that your teams will
                    love.
                </h2>
                <p>
                    Create the customer experience that your in-store teams can
            ...
            <div className="flex flex-col gap-13 ">
                <ProcessCardComponent
                    title={"Review."}
                    description={
                        "Track every stores progress and easily give feedback and approval."
                    }
